...
colors = [ subprocess.getoutput("tput setaf %d" % i) for i in range(1,7) ]
bright = [ subprocess.getoutput("tput setaf %d" % i) for i in range(9,15) ]
...
print(subprocess.getoutput("tput sgr0"))
